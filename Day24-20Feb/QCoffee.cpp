...
class CoffeeMakerAPI { public:
    ...
    static const int WARMER_EMPTY = 0;
    static const int POT_EMPTY = 1;
    static const int POT_NOT_EMPTY = 2;
     ...
     */
    int getBoilerStatus();
    static const int BOILER_EMPTY = 0;
    static const int BOILER_NOT_EMPTY = 1;
    ...
    static const int BREW_BUTTON_PUSHED = 0;
    static const int BREW_BUTTON_NOT_PUSHED = 1;
    ...
    static const int BOILER_ON = 0;
    static const int BOILER_OFF = 1;
    ...
    static const int WARMER_ON = 0;
    static const int WARMER_OFF = 1;
    ...
    static const int INDICATOR_ON = 0;
    static const int INDICATOR_OFF = 1;
     ...
     */
     ...
     static const int VALVE_OPEN = 0;
     static const int VALVE_CLOSED = 1;
};
